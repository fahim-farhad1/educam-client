...
const AddClasses = () => {
  ...
  const onSubmit = (data) => {
    const {course_image, course_name, course_instructor, course_description, course_price, available_seats, instructor_email} = data;
    const courseData = {
      course_image,
      course_name,
      course_instructor,
    ...
    fetch("http://localhost:3000/uploadclass", {
      method: "POST",
      headers: {
      ...
      <div className="card shadow-md p-5 mx-auto">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            value={addclass.map((classes) => classes.name)}
            readOnly
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            value={addclass.map((classes) => classes.email)}
            readOnly
          />
        </div>
        <div className="mb-4">
